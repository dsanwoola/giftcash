...
export function buildSeed(): Store {
  ...
  const weddingEvent: GiftEvent = {
    ...
    checkInEnabled: true,
    ticketTypes: [
      { id: "regular", name: "Regular", description: "General admission wedding pass", price: 0, currency: "NGN", quantity: 200, sold: 86, benefits: ["Digital QR pass", "Reception access"], active: true },
      { id: "vip", name: "VIP", description: "Premium table access", price: toMinor(50_000), currency: "NGN", quantity: 40, sold: 12, benefits: ["VIP pass", "Priority check-in", "Premium seating"], active: true },
    ],
    tables: Array.from({ length: 12 }, (_, index) => ({
      ...
      capacity: 10,
      price: index < 2 ? toMinor(500_000) : undefined,
      currency: "NGN" as const,
      paymentStatus: index < 2 ? "reserved" as const : undefined,
      assignedGuestIds: [],
    })),
    guests: [],
    tickets: [],
